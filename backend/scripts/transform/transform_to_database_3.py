...
if __name__ == "__main__":
    ...
    companies_json = read_latest_file_in_directory('/home/thong/WorkSpace/Project/backend/data/raw/companies')
    ...
    path = f"/home/thong/WorkSpace/Project/backend/data/processed/transformed_to_database_companies/process_companies_{date}.json"
