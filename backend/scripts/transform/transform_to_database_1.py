...
def read_latest_file_in_directory(directory):
    """
    Read the latest file in a directory with a specific extension.
    """
    extension = '.json'
...
def save_to_json(dataframe, filename):
    ...
    # Use orient='records' and lines=True for better compatibility with large datasets
    dataframe.to_json(filename, orient='records', lines=True)
    print(f"Data saved to {filename}")

if __name__ == "__main__":
    #Read latest companies and markets data
    companies = read_latest_file_in_directory('/home/thong/WorkSpace/Project/backend/data/raw/companies')
    markets = read_latest_file_in_directory('/home/thong/WorkSpace/Project/backend/data/raw/markets')
    ...
    regions_path = f"/home/thong/WorkSpace/Project/backend/data/processed/transformed_to_database_regions/process_regions_{date}.json"
    ...
    industries_path = f"/home/thong/WorkSpace/Project/backend/data/processed/transformed_to_database_industries/process_industries_{date}.json"
    ...
    sicindustries_path = f"/home/thong/WorkSpace/Project/backend/data/processed/transformed_to_database_sicindustries/process_sicindustries_{date}.json"
