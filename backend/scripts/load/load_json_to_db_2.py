...
if __name__ == "__main__":
    ...
    directory = '/home/thong/WorkSpace/Project/backend/data/processed/transformed_to_database_exchanges'
    ...
    if latest_file:
        insert_data_from_json_to_db(latest_file, table_name, columns, conflict_columns)
    else:
